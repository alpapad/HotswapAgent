...
public class WaitHelper {
	...
	/**
	 * Wait for result set to true by another thread in resultHolder. Default
	 * timeout 1000ms.
	 *
	 * @param resultHolder
	 *            holder of a boolean result - wait for value "true"
	...
	/**
	 * Holder to share result between threads. Another thread will set result to
	 * true.
	 */
	...
	public static abstract class Command {
		 ...
		 *             any exception is considered as false result
		 */
