...
public class URLClassLoaderHelper {
	...
	/**
	 * Insert classpath at the beginning of the classloader path. This
	 * implementation will replace ucp field (URLClassPath) with new definition.
	 * Any existing Loader is discarded and recreated.
	 *
	 * @param classLoader
	 *            URL classloader
	...
	private static class ExtraURLClassPath extends sun.misc.URLClassPath {
		...
		/**
		 * Return orig classpath as was set by hotswap agent. Note: cannot use
		 * classLoader.getURLs(), because Tomcat WebappClassLoader does not
		 * return modified classPath.
		 */
