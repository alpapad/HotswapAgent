...
public class ClassLoaderProxy {
	...
	public CtClass create(CtClass classToProxy) throws Exception {
		...
		//
		// @Override
		// public Object invoke(Object self, Method overridden, Method
		// forwarder,
		// Object[] args) throws Throwable {
		// System.out.println("do something "+overridden.getName());
		//
		// Class classInTargetClassLoader =
		// targetClassLoader.loadClass(classToProxy.getName());
		// Method methodInTargetClassLoader =
		// classInTargetClassLoader.getDeclaredMethod(
