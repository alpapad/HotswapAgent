...
/**
 * Get signature for an anonymous class to compare two versions (before and
 * after reload).
 *
 * @author Jiri Bubnik
 */
public class AnonymousClassInfo {
	...
	public AnonymousClassInfo(Class<?> c) {
		...
		for (Field f : c.getDeclaredFields()) {
			// replace declarig class for constant because of unit tests (class
			// name change)
	...
	/**
	 * Exact match of class, interfaces, declared methods and fields. May be
	 * different enclosing method.
	 */
	...
	/**
	 * The least matching variant - same class signature can be still resolved
	 * by hotswap.
	 */
