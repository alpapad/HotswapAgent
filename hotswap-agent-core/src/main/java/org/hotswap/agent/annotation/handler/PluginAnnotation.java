 ...
 * <p/>
 * Either method OR field is filled - never both (annotation on method or
 * field).
 *
 * @author Jiri Bubnik
 */
public class PluginAnnotation<T extends Annotation> {
	...
	/**
	 * Return plugin class (the plugin to which this annotation belongs - not
	 * necessarily declaring class.
	 */
	...
	public String toString() {
		return "PluginAnnotation{" + "plugin=" + plugin + ", annotation=" + annotation + ", field=" + field
				+ ", method=" + method + '}';
	}
}
