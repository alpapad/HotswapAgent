...
/**
 * Command to run in a target classloader. The command is always invoked via
 * reflection.
 *
 * @author Jiri Bubnik
 */
public class ReflectionCommand extends MergeableCommand {
	...
	/**
	 * Run a method in the class - if null, run a method on this object,
	 * otherwise create new instance of className.
	 */
	...
	/**
	 * Method actual parameters value. These parameter types must be known to
	 * the target classloader. For norma use (call application classloader from
	 * plugin class) this means that you can use only Java default types.
	 */
	private List<Object> params = new ArrayList<Object>();

	/**
	 * Plugin object to resolve target classloader (if not set directly). May be
	 * null.
	 */
	private Object plugin;

	/**
	 * Classloader application classloader to run the command in. If null, use
	 * agent classloader.
	 */
	private ClassLoader targetClassLoader;

	/**
	 * Register a eventListener after the command is executed to obtain method
	 * invocation result.
	 */
	 ...
	 * Define a command.
	 */
	public ReflectionCommand(Object plugin, String className, String methodName, ClassLoader targetClassLoader,
			Object... params) {
		this.plugin = plugin;
	...
	/**
	 * Predefine a command. The params and/or target classloader will be set by
	 * setter.
	 */
	...
	protected Object doExecuteReflectionCommand(ClassLoader targetClassLoader, String className, Object target,
			String method, List<Object> params) throws ClassNotFoundException, IllegalAccessException,
					InstantiationException, NoSuchMethodException, InvocationTargetException {
		Class<?> classInAppClassLoader = Class.forName(className, true, targetClassLoader);

		LOGGER.trace(
				"Executing command: requestedClassLoader={}, resolvedClassLoader={}, class={}, method={}, params={}",
	...
	public boolean equals(Object o) {
		...
		if (targetClassLoader != null ? !targetClassLoader.equals(that.targetClassLoader)
				: that.targetClassLoader != null) {
			return false;
		}
