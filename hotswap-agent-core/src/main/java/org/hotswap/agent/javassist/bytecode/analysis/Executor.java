...
public class Executor implements org.hotswap.agent.javassist.bytecode.Opcode {
	 ...
	 */
	public void execute(MethodInfo method, int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iter, Frame frame,
		...
		case LDC2_W:
			...
			break;
		case ILOAD:
			evalLoad(org.hotswap.agent.javassist.bytecode.analysis.Type.INTEGER, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case LLOAD:
		...
		case FLOAD:
			...
			break;
		case DLOAD:
			evalLoad(org.hotswap.agent.javassist.bytecode.analysis.Type.DOUBLE, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case ALOAD:
			evalLoad(org.hotswap.agent.javassist.bytecode.analysis.Type.OBJECT, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case ILOAD_0:
		case ILOAD_1:
		...
		case SALOAD:
			...
			break;
		case ISTORE:
			evalStore(org.hotswap.agent.javassist.bytecode.analysis.Type.INTEGER, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case LSTORE:
			...
			break;
		case FSTORE:
			evalStore(org.hotswap.agent.javassist.bytecode.analysis.Type.FLOAT, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case DSTORE:
			evalStore(org.hotswap.agent.javassist.bytecode.analysis.Type.DOUBLE, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case ASTORE:
			evalStore(org.hotswap.agent.javassist.bytecode.analysis.Type.OBJECT, iter.byteAt(pos + 1), frame,
					subroutine);
			break;
		case ISTORE_0:
		case ISTORE_1:
		...
		case JSR:
			...
			break;
		case RET:
			verifyAssignable(org.hotswap.agent.javassist.bytecode.analysis.Type.RETURN_ADDRESS,
	...
	private void evalArrayLoad(org.hotswap.agent.javassist.bytecode.analysis.Type expectedComponent, Frame frame)
			throws BadBytecode {
	...
	private void evalArrayStore(org.hotswap.agent.javassist.bytecode.analysis.Type expectedComponent, Frame frame)
			throws BadBytecode {
	...
	private void evalBinaryMath(org.hotswap.agent.javassist.bytecode.analysis.Type expected, Frame frame)
			throws BadBytecode {
	...
	private void evalGetField(int opcode, int index, Frame frame) throws BadBytecode {
		...
		if (opcode == GETFIELD) {
			org.hotswap.agent.javassist.bytecode.analysis.Type objectType = resolveClassInfo(
	...
	private void evalLoad(org.hotswap.agent.javassist.bytecode.analysis.Type expected, int index, Frame frame,
			Subroutine subroutine) throws BadBytecode {
	...
	private void evalNewArray(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iter, Frame frame)
			throws BadBytecode {
		verifyAssignable(org.hotswap.agent.javassist.bytecode.analysis.Type.INTEGER, simplePop(frame));
	...
	private void evalNewObjectArray(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iter, Frame frame)
			throws BadBytecode {
		// Convert to x[] format
		org.hotswap.agent.javassist.bytecode.analysis.Type type = resolveClassInfo(
				constPool.getClassInfo(iter.u16bitAt(pos + 1)));
	...
	private void evalShift(org.hotswap.agent.javassist.bytecode.analysis.Type expected, Frame frame)
			throws BadBytecode {
		org.hotswap.agent.javassist.bytecode.analysis.Type value2 = simplePop(frame);
		org.hotswap.agent.javassist.bytecode.analysis.Type value1 = simplePop(frame);
	...
	private void evalStore(org.hotswap.agent.javassist.bytecode.analysis.Type expected, int index, Frame frame,
			Subroutine subroutine) throws BadBytecode {
		org.hotswap.agent.javassist.bytecode.analysis.Type type = simplePop(frame);

		// RETURN_ADDRESS is allowed by ASTORE
		if (!(expected == org.hotswap.agent.javassist.bytecode.analysis.Type.OBJECT
				&& type == org.hotswap.agent.javassist.bytecode.analysis.Type.RETURN_ADDRESS)) {
			verifyAssignable(expected, type);
		}
	...
	private void evalWide(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iter, Frame frame,
			Subroutine subroutine) throws BadBytecode {
	...
	private org.hotswap.agent.javassist.bytecode.analysis.Type simplePeek(Frame frame) {
		org.hotswap.agent.javassist.bytecode.analysis.Type type = frame.peek();
		return type == org.hotswap.agent.javassist.bytecode.analysis.Type.TOP ? frame.getStack(frame.getTopIndex() - 1)
				: type;
	}
	...
	private void verifyAssignable(org.hotswap.agent.javassist.bytecode.analysis.Type expected,
			org.hotswap.agent.javassist.bytecode.analysis.Type type) throws BadBytecode {
