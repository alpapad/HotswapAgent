...
public class TypeChecker extends org.hotswap.agent.javassist.compiler.ast.Visitor
	...
	protected void atMultiNewArray(int type, org.hotswap.agent.javassist.compiler.ast.ASTList classname,
			org.hotswap.agent.javassist.compiler.ast.ASTList size) throws CompileError {
	...
	public void atAssignExpr(org.hotswap.agent.javassist.compiler.ast.AssignExpr expr) throws CompileError {
		...
		if (left instanceof org.hotswap.agent.javassist.compiler.ast.Variable) {
			atVariableAssign(expr, op, (org.hotswap.agent.javassist.compiler.ast.Variable) left,
					((org.hotswap.agent.javassist.compiler.ast.Variable) left).getDeclarator(), right);
		} else {
		...
		if (k >= 0) {
			...
			if (token == '+') {
				...
				if (e != null) {
					 ...
					 */
					e = org.hotswap.agent.javassist.compiler.ast.CallExpr
							.makeCall(org.hotswap.agent.javassist.compiler.ast.Expr.make('.', e,
	 ...
	 */
	private org.hotswap.agent.javassist.compiler.ast.Expr atPlusExpr(
			org.hotswap.agent.javassist.compiler.ast.BinExpr expr) throws CompileError {
		org.hotswap.agent.javassist.compiler.ast.ASTree left = expr.oprand1();
		org.hotswap.agent.javassist.compiler.ast.ASTree right = expr.oprand2();
		if (right == null) {
		...
		if (isPlusExpr(left)) {
			org.hotswap.agent.javassist.compiler.ast.Expr newExpr = atPlusExpr(
					(org.hotswap.agent.javassist.compiler.ast.BinExpr) left);
			if (newExpr != null) {
				right.accept(this);
				exprType = CLASS;
				arrayDim = 0;
		...
		if (type1 == CLASS && dim1 == 0 && jvmJavaLangString.equals(cname)
			...
			org.hotswap.agent.javassist.compiler.ast.ASTList sbufClass = org.hotswap.agent.javassist.compiler.ast.ASTList
					.make(new org.hotswap.agent.javassist.compiler.ast.Symbol("java"),
							new org.hotswap.agent.javassist.compiler.ast.Symbol("lang"),
							new org.hotswap.agent.javassist.compiler.ast.Symbol("StringBuffer"));
			org.hotswap.agent.javassist.compiler.ast.ASTree e = new org.hotswap.agent.javassist.compiler.ast.NewExpr(
					sbufClass, null);
			exprType = CLASS;
			arrayDim = 0;
			className = "java/lang/StringBuffer";
	...
	private boolean isConstant(org.hotswap.agent.javassist.compiler.ast.BinExpr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.ASTree left, org.hotswap.agent.javassist.compiler.ast.ASTree right)
					throws CompileError {
		left = stripPlusExpr(left);
		right = stripPlusExpr(right);
		org.hotswap.agent.javassist.compiler.ast.ASTree newExpr = null;
		if (left instanceof org.hotswap.agent.javassist.compiler.ast.StringL
				&& right instanceof org.hotswap.agent.javassist.compiler.ast.StringL && op == '+') {
			newExpr = new org.hotswap.agent.javassist.compiler.ast.StringL(
					((org.hotswap.agent.javassist.compiler.ast.StringL) left).get()
	 ...
	 */
	static org.hotswap.agent.javassist.compiler.ast.ASTree stripPlusExpr(
		...
		if (expr instanceof org.hotswap.agent.javassist.compiler.ast.BinExpr) {
		...
		} else if (expr instanceof org.hotswap.agent.javassist.compiler.ast.Expr) { // note:
																					// BinExpr
																					// extends
																					// Expr.
			...
			if (op == MEMBER) {
				org.hotswap.agent.javassist.compiler.ast.ASTree cexpr = getConstantFieldValue(
						(org.hotswap.agent.javassist.compiler.ast.Member) e.oprand2());
				if (cexpr != null) {
					return cexpr;
				}
			...
			org.hotswap.agent.javassist.compiler.ast.ASTree cexpr = getConstantFieldValue(
					(org.hotswap.agent.javassist.compiler.ast.Member) expr);
			if (cexpr != null) {
				return cexpr;
			}
		}
	 ...
	 */
	private static org.hotswap.agent.javassist.compiler.ast.ASTree getConstantFieldValue(
			org.hotswap.agent.javassist.compiler.ast.Member mem) {
		return getConstantFieldValue(mem.getField());
	}

	public static org.hotswap.agent.javassist.compiler.ast.ASTree getConstantFieldValue(
		...
		if (value instanceof String) {
			...
			return new org.hotswap.agent.javassist.compiler.ast.Keyword(
					((Boolean) value).booleanValue() ? TokenId.TRUE : TokenId.FALSE);
		} else {
			return null;
		}
	}
	...
	private static org.hotswap.agent.javassist.compiler.ast.Expr makeAppendCall(
			org.hotswap.agent.javassist.compiler.ast.ASTree target,
			org.hotswap.agent.javassist.compiler.ast.ASTree arg) {
		return org.hotswap.agent.javassist.compiler.ast.CallExpr.makeCall(
				org.hotswap.agent.javassist.compiler.ast.Expr.make('.', target,
						new org.hotswap.agent.javassist.compiler.ast.Member("append")),
	...
	private void booleanExpr(org.hotswap.agent.javassist.compiler.ast.ASTree expr) throws CompileError {
	...
	private boolean isConstant(org.hotswap.agent.javassist.compiler.ast.Expr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.ASTree oprand) {
		...
		if (method instanceof org.hotswap.agent.javassist.compiler.ast.Member) {
			...
			if (op == MEMBER) {
				...
				try {
					...
					e.setOprand1(new org.hotswap.agent.javassist.compiler.ast.Symbol(
							MemberResolver.jvmToJavaName(className)));
				}
	 ...
	 */
	public MemberResolver.Method atMethodCallCore(org.hotswap.agent.javassist.CtClass targetClass, String mname,
		...
		MemberResolver.Method found = resolver.lookupMethod(targetClass, thisClass, thisMethod, mname, types, dims,
				cnames);
		if (found == null) {
	...
	protected org.hotswap.agent.javassist.CtField fieldAccess(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
		...
		if (expr instanceof org.hotswap.agent.javassist.compiler.ast.Member) {
			...
			int op = e.getOperator();
			if (op == MEMBER) {
				org.hotswap.agent.javassist.compiler.ast.Member mem = (org.hotswap.agent.javassist.compiler.ast.Member) e
						.oprand2();
				org.hotswap.agent.javassist.CtField f = resolver
						.lookupField(((org.hotswap.agent.javassist.compiler.ast.Symbol) e.oprand1()).get(), mem);
				mem.setField(f);
				return f;
			} else if (op == '.') {
				try {
	...
	private org.hotswap.agent.javassist.CtField fieldAccess2(org.hotswap.agent.javassist.compiler.ast.Expr e,
			String jvmClassName) throws CompileError {
		org.hotswap.agent.javassist.compiler.ast.Member fname = (org.hotswap.agent.javassist.compiler.ast.Member) e
				.oprand2();
	...
	public void atArrayRead(org.hotswap.agent.javassist.compiler.ast.ASTree array,
			org.hotswap.agent.javassist.compiler.ast.ASTree index) throws CompileError {
		array.accept(this);
		int type = exprType;
		int dim = arrayDim;
		String cname = className;
	...
	private void atPlusPlus(int token, org.hotswap.agent.javassist.compiler.ast.ASTree oprand,
			org.hotswap.agent.javassist.compiler.ast.Expr expr) throws CompileError {
