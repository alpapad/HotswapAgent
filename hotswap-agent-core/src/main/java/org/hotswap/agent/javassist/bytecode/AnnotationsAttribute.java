 ...
 * <p/>
 * <p>
 * The last statement is necessary if the class file was produced by Javassist
 * or JDK 1.4. Otherwise, it is not necessary.
 *
...
public class AnnotationsAttribute extends AttributeInfo {
	...
	static class Renamer extends Walker {
		 ...
		 *            null.
		 */
		Renamer(byte[] info, org.hotswap.agent.javassist.bytecode.ConstPool cp, Map<String, String> map) {
			super(info);
			cpool = cp;
			classnames = map;
		}
	...
	static class Copier extends Walker {
		 ...
		 *            null.
		 */
		Copier(byte[] info, ConstPool src,
				ConstPool dest, Map<String, String> map) {
			super(info);
	...
	static class Parser extends Walker {
		...
		org.hotswap.agent.javassist.bytecode.annotation.Annotation[][] allParams; // all
																					// parameters
		org.hotswap.agent.javassist.bytecode.annotation.Annotation[] allAnno; // all
																				// annotations
		org.hotswap.agent.javassist.bytecode.annotation.Annotation currentAnno; // current
																				// annotation
		org.hotswap.agent.javassist.bytecode.annotation.MemberValue currentMember; // current
																					// member
		...
		int annotationMemberValue(int pos) throws Exception {
			...
			currentMember = new org.hotswap.agent.javassist.bytecode.annotation.AnnotationMemberValue(currentAnno,
					pool);
			currentAnno = anno;
			return pos;
		}
		...
		@Override
		int arrayMemberValue(int pos, int num) throws Exception {
			org.hotswap.agent.javassist.bytecode.annotation.ArrayMemberValue amv = new org.hotswap.agent.javassist.bytecode.annotation.ArrayMemberValue(
					pool);
