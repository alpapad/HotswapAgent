...
public class MethodInfo {
	...
	void prune(org.hotswap.agent.javassist.bytecode.ConstPool cp) {
		...
		org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute defaultAttribute = (org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute) getAttribute(
				org.hotswap.agent.javassist.bytecode.AnnotationDefaultAttribute.tag);
		...
		AttributeInfo signature = getAttribute(org.hotswap.agent.javassist.bytecode.SignatureAttribute.tag);
		if (signature != null) {
	 ...
	 * @since 3.6
	 */
	public void rebuildStackMapIf6(org.hotswap.agent.javassist.ClassPool pool,
			org.hotswap.agent.javassist.bytecode.ClassFile cf) throws BadBytecode {
	...
	private void read(MethodInfo src, String methodname, Map<String, String> classnames) throws BadBytecode {
