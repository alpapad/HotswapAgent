...
public class JvstTypeChecker extends TypeChecker {
	...
	public JvstTypeChecker(org.hotswap.agent.javassist.CtClass cc, org.hotswap.agent.javassist.ClassPool cp,
	 ...
	 * this does nothing.
	 */
	protected void atCastToRtype(org.hotswap.agent.javassist.compiler.ast.CastExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	protected void atCastToWrapper(org.hotswap.agent.javassist.compiler.ast.CastExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		expr.getOprand().accept(this);
	 ...
	 * To support $cflow().
	 */
	protected void atCflow(org.hotswap.agent.javassist.compiler.ast.ASTList cname)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		exprType = INT;
		arrayDim = 0;
		className = null;
	 ...
	 * does nothing.
	 */
	public void setType(org.hotswap.agent.javassist.CtClass type)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		setType(type, 0);
	}

	private void setType(org.hotswap.agent.javassist.CtClass type, int dim)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (type.isPrimitive()) {
