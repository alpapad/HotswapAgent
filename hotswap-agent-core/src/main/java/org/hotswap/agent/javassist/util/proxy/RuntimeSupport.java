...
public class RuntimeSupport {
	...
	public static org.hotswap.agent.javassist.util.proxy.SerializedProxy makeSerializedProxy(Object proxy)
		...
		if (proxy instanceof ProxyObject) {
			...
			methodHandler = org.hotswap.agent.javassist.util.proxy.ProxyFactory
					.getHandler((org.hotswap.agent.javassist.util.proxy.Proxy) proxy);
		}

		return new org.hotswap.agent.javassist.util.proxy.SerializedProxy(clazz,
				org.hotswap.agent.javassist.util.proxy.ProxyFactory.getFilterSignature(clazz), methodHandler);
	}
}
