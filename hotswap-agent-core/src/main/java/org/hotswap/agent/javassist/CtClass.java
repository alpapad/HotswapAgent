...
public abstract class CtClass {
	 ...
	 *
	 * <pre>
	 * java -jar org.hotswap.agent.javassist.jar
	 * </pre>
	 */
	...
	static {
		...
		booleanType = new CtPrimitiveType("boolean", 'Z', "java.lang.Boolean", "booleanValue", "()Z", Opcode.IRETURN,
				Opcode.T_BOOLEAN, 1);
		primitiveTypes[0] = booleanType;

		charType = new CtPrimitiveType("char", 'C', "java.lang.Character", "charValue", "()C", Opcode.IRETURN,
				Opcode.T_CHAR, 1);
		primitiveTypes[1] = charType;

		byteType = new CtPrimitiveType("byte", 'B', "java.lang.Byte", "byteValue", "()B", Opcode.IRETURN, Opcode.T_BYTE,
				1);
		primitiveTypes[2] = byteType;

		shortType = new CtPrimitiveType("short", 'S', "java.lang.Short", "shortValue", "()S", Opcode.IRETURN,
				Opcode.T_SHORT, 1);
		primitiveTypes[3] = shortType;

		intType = new CtPrimitiveType("int", 'I', "java.lang.Integer", "intValue", "()I", Opcode.IRETURN, Opcode.T_INT,
				1);
		primitiveTypes[4] = intType;

		longType = new CtPrimitiveType("long", 'J', "java.lang.Long", "longValue", "()J", Opcode.LRETURN, Opcode.T_LONG,
				2);
		primitiveTypes[5] = longType;

		floatType = new CtPrimitiveType("float", 'F', "java.lang.Float", "floatValue", "()F", Opcode.FRETURN,
				Opcode.T_FLOAT, 1);
		primitiveTypes[6] = floatType;

		doubleType = new CtPrimitiveType("double", 'D', "java.lang.Double", "doubleValue", "()D", Opcode.DRETURN,
				Opcode.T_DOUBLE, 2);
	 ...
	 * decoding, use <code>org.hotswap.agent.javassist.Modifier</code>.
	 *
	 * <p>
	 ...
	 *            <code>org.hotswap.agent.javassist.Modifier</code>
	 * @see Modifier
	 */
	 ...
	 * <code>org.hotswap.agent.javassist.bytecode.Descriptor</code>.
	 *
	 * @param desc
	 *            method descriptor
	 ...
	 *
	 * @see org.hotswap.agent.javassist.CtConstructor
	 */
	 ...
	 * be added.
	 *
	 * @see org.hotswap.agent.javassist.CtField#CtField(CtField,CtClass)
	 */
	 ...
	 * <code>org.hotswap.agent.javassist.bytecode</code> package. For example,
	 * the following expression returns all the attributes of a class file.
	 *
	 * <pre>
	 ...
	 * For dealing with attributes, see the
	 * <code>org.hotswap.agent.javassist.bytecode</code> package. For example,
	 * the following expression adds an attribute <code>info</code> to a class
	 * file.
	 *
	 * <pre>
