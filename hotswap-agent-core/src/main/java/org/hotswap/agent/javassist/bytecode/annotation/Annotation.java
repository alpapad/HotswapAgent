...
public class Annotation {
	 ...
	 */
	public Annotation(ConstPool cp, org.hotswap.agent.javassist.CtClass clazz) throws NotFoundException {
		...
		for (CtMethod method : methods) {
			org.hotswap.agent.javassist.CtClass returnType = method.getReturnType();
			addMemberValue(method.getName(), createMemberValue(cp, returnType));
	 ...
	 */
	public static org.hotswap.agent.javassist.bytecode.annotation.MemberValue createMemberValue(ConstPool cp,
			org.hotswap.agent.javassist.CtClass type) throws NotFoundException {
	 ...
	 * @throws org.hotswap.agent.javassist.bytecode.annotation.NoSuchClassError
	...
	public Object toAnnotationType(ClassLoader cl, org.hotswap.agent.javassist.ClassPool cp)
		...
		return org.hotswap.agent.javassist.bytecode.annotation.AnnotationImpl.make(cl,
				org.hotswap.agent.javassist.bytecode.annotation.MemberValue.loadClass(cl, getTypeName()), cp, this);
	}
