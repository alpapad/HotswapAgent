...
public final class ClassFile {
	...
	public ClassFile(boolean isInterface, String classname, String superclass) {
		...
		if (isInterface) {
			accessFlags = org.hotswap.agent.javassist.bytecode.AccessFlag.INTERFACE
	...
	public void compact() {
		...
		ArrayList<FieldInfo> fl = fields;
		n = fl.size();
		for (int i = 0; i < n; ++i) {
			FieldInfo finfo = fl.get(i);
			finfo.compact(cp);
		}
	...
	public int getInnerAccessFlags() {
		org.hotswap.agent.javassist.bytecode.InnerClassesAttribute ica = (org.hotswap.agent.javassist.bytecode.InnerClassesAttribute) getAttribute(
				org.hotswap.agent.javassist.bytecode.InnerClassesAttribute.tag);
		if (ica == null) {
			return -1;
		}
