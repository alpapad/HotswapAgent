...
public abstract class Transformer implements org.hotswap.agent.javassist.bytecode.Opcode {
	...
	public void initialize(org.hotswap.agent.javassist.bytecode.ConstPool cp, org.hotswap.agent.javassist.CtClass clazz,
	...
	public abstract int transform(org.hotswap.agent.javassist.CtClass clazz, int pos,
			org.hotswap.agent.javassist.bytecode.CodeIterator it, org.hotswap.agent.javassist.bytecode.ConstPool cp)
					throws org.hotswap.agent.javassist.CannotCompileException,
