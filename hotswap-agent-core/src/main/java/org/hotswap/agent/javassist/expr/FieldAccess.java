...
public class FieldAccess extends Expr {
	...
	protected FieldAccess(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator i,
	 ...
	 * specification.
	 *
	 * @see org.hotswap.agent.javassist.bytecode.Descriptor#toCtClass(String,
	...
	public void replace(String statement) throws org.hotswap.agent.javassist.CannotCompileException {
		...
		try {
			...
			org.hotswap.agent.javassist.CtClass fieldType = org.hotswap.agent.javassist.bytecode.Descriptor
					.toCtClass(constPool.getFieldrefType(index), thisClass.getClassPool());
	...
	static class ProceedForWrite implements org.hotswap.agent.javassist.compiler.ProceedHandler {
		...
		public void doit(org.hotswap.agent.javassist.compiler.JvstCodeGen gen,
			...
			if (gen.getMethodArgsLength(args) != 1) {
				throw new org.hotswap.agent.javassist.compiler.CompileError(
						org.hotswap.agent.javassist.compiler.Javac.proceedName
								+ "() cannot take more than one parameter " + "for field writing");
			}
