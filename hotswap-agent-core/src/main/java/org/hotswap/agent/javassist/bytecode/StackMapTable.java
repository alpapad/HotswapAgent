...
public class StackMapTable extends AttributeInfo {
	...
	static class SimpleCopy extends Walker {
		...
		public void fullFrame(int pos, int offsetDelta, int[] localTags, int[] localData, int[] stackTags,
				int[] stackData) {
			writer.fullFrame(offsetDelta, localTags, copyData(localTags, localData), stackTags,
	 ...
	 * <p/>
	 * <p>
	 * This method is for TransformNew. It is called to update the stack map
	...
	static class NewRemover extends SimpleCopy {
		...
		public void fullFrame(int pos, int offsetDelta, int[] localTags, int[] localData, int[] stackTags,
			...
			for (int i = 0; i < n; i++) {
				if (stackTags[i] == UNINIT && stackData[i] == posOfNew && stackTags[i + 1] == UNINIT
