...
public class FactoryHelper {
	 ...
	 */
	public static final Class<?>[] primitiveTypes = { Boolean.TYPE, Byte.TYPE, Character.TYPE, Short.TYPE, Integer.TYPE,
			Long.TYPE, Float.TYPE, Double.TYPE, Void.TYPE };

	/**
	 * The fully-qualified names of wrapper classes for primitive types.
	 */
	public static final String[] wrapperTypes = { "java.lang.Boolean", "java.lang.Byte", "java.lang.Character",
	 ...
	 */
	public static final String[] unwarpMethods = { "booleanValue", "byteValue", "charValue", "shortValue", "intValue",
	 ...
	 *
	 * @see #toClass(org.hotswap.agent.javassist.bytecode.ClassFile,
	 ...
	 */
	public static Class<?> toClass(org.hotswap.agent.javassist.bytecode.ClassFile cf, ClassLoader loader,
			ProtectionDomain domain) throws org.hotswap.agent.javassist.CannotCompileException {
		try {
