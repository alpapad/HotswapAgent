...
public class Instanceof extends Expr {
	 ...
	 */
	protected Instanceof(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator i,
	...
	public void replace(String statement) throws org.hotswap.agent.javassist.CannotCompileException {
		...
		try {
			org.hotswap.agent.javassist.CtClass[] params = new org.hotswap.agent.javassist.CtClass[] {
					cp.get(javaLangObject) };
			...
			if (gen.getMethodArgsLength(args) != 1) {
				throw new org.hotswap.agent.javassist.compiler.CompileError(
						org.hotswap.agent.javassist.compiler.Javac.proceedName
								+ "() cannot take more than one parameter " + "for instanceof");
			}
