...
public final class FramePrinter {
	...
	private String getMethodString(org.hotswap.agent.javassist.CtMethod method) {
		try {
			return Modifier.toString(method.getModifiers()) + " " + method.getReturnType().getName() + " "
					+ method.getName() + org.hotswap.agent.javassist.bytecode.Descriptor.toString(method.getSignature())
					+ ";";
	...
	public void print(org.hotswap.agent.javassist.CtMethod method) {
		...
		while (iterator.hasNext()) {
			...
			stream.println(pos + ": "
					+ org.hotswap.agent.javassist.bytecode.InstructionPrinter.instructionString(iterator, pos, pool));
