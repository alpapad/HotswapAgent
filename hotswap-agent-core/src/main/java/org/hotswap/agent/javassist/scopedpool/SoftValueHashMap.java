...
public class SoftValueHashMap extends AbstractMap implements Map {
	 ...
	 */
	@Override
	public Set<Map.Entry<Object, SoftValueRef>> entrySet() {
		processQueue();
		return hash.entrySet();
	}

	/* Hash table mapping WeakKeys to values */
	private Map<Object, SoftValueRef> hash;
	...
	public SoftValueHashMap(int initialCapacity, float loadFactor) {
		hash = new HashMap<Object, SoftValueRef>(initialCapacity, loadFactor);
	}
	...
	public SoftValueHashMap(int initialCapacity) {
		hash = new HashMap<Object, SoftValueRef>(initialCapacity);
	}
	...
	public SoftValueHashMap() {
		hash = new HashMap<Object, SoftValueRef>();
	}
	...
	public Object get(Object key) {
		processQueue();
		SoftReference<?> ref = hash.get(key);
		if (ref != null) {
			return ref.get();
		}
		return null;
