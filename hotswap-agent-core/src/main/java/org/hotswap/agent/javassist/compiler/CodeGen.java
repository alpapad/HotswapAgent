...
public abstract class CodeGen extends org.hotswap.agent.javassist.compiler.ast.Visitor
		implements org.hotswap.agent.javassist.bytecode.Opcode, TokenId {
	...
	public void compileExpr(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		doTypeCheck(expr);
		expr.accept(this);
	}
	...
	public void doTypeCheck(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (typeChecker != null) {
	...
	@Override
	public void atASTList(org.hotswap.agent.javassist.compiler.ast.ASTList n)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		fatal();
	}

	@Override
	public void atPair(org.hotswap.agent.javassist.compiler.ast.Pair n)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		fatal();
	}

	@Override
	public void atSymbol(org.hotswap.agent.javassist.compiler.ast.Symbol n)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		fatal();
	}

	@Override
	public void atFieldDecl(org.hotswap.agent.javassist.compiler.ast.FieldDecl field)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		field.getInit().accept(this);
	}

	@Override
	public void atMethodDecl(org.hotswap.agent.javassist.compiler.ast.MethodDecl method)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		org.hotswap.agent.javassist.compiler.ast.ASTList mods = method.getModifiers();
		setMaxLocals(1);
		while (mods != null) {
			org.hotswap.agent.javassist.compiler.ast.Keyword k = (org.hotswap.agent.javassist.compiler.ast.Keyword) mods
					.head();
			mods = mods.tail();
			if (k.get() == STATIC) {
				setMaxLocals(0);
	...
	private boolean needsSuperCall(org.hotswap.agent.javassist.compiler.ast.Stmnt body)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		...
		if (body != null && body.getOperator() == EXPR) {
			...
			if (expr != null && expr instanceof org.hotswap.agent.javassist.compiler.ast.Expr
				...
				org.hotswap.agent.javassist.compiler.ast.ASTree target = ((org.hotswap.agent.javassist.compiler.ast.Expr) expr)
						.head();
	...
	@Override
	public void atStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (st == null) {
			return; // empty
		}
	...
	private void atIfStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		org.hotswap.agent.javassist.compiler.ast.ASTree expr = st.head();
		org.hotswap.agent.javassist.compiler.ast.Stmnt thenp = (org.hotswap.agent.javassist.compiler.ast.Stmnt) st
				.tail().head();
		org.hotswap.agent.javassist.compiler.ast.Stmnt elsep = (org.hotswap.agent.javassist.compiler.ast.Stmnt) st
				.tail().tail().head();
	...
	private void atWhileStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st, boolean notDo)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	private void atForStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		ArrayList<Integer> prevBreakList = breakList;
		ArrayList<Integer> prevContList = continueList;
		breakList = new ArrayList<Integer>();
		...
		org.hotswap.agent.javassist.compiler.ast.Stmnt init = (org.hotswap.agent.javassist.compiler.ast.Stmnt) st
				.head();
		org.hotswap.agent.javassist.compiler.ast.ASTList p = st.tail();
		org.hotswap.agent.javassist.compiler.ast.ASTree expr = p.head();
		p = p.tail();
		org.hotswap.agent.javassist.compiler.ast.Stmnt update = (org.hotswap.agent.javassist.compiler.ast.Stmnt) p
				.head();
	...
	private void atSwitchStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		compileExpr(st.head());
		...
		int defaultPc = -1;
		for (org.hotswap.agent.javassist.compiler.ast.ASTList list = body; list != null; list = list.tail()) {
			org.hotswap.agent.javassist.compiler.ast.Stmnt label = (org.hotswap.agent.javassist.compiler.ast.Stmnt) list
					.head();
	...
	private int computeLabel(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		doTypeCheck(expr);
	...
	private void atBreakStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st, boolean notCont)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (st.head() != null) {
			throw new org.hotswap.agent.javassist.compiler.CompileError("sorry, not support labeled break or continue");
		}
	...
	protected void atReturnStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		atReturnStmnt2(st.getLeft());
	}

	protected final void atReturnStmnt2(org.hotswap.agent.javassist.compiler.ast.ASTree result)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		int op;
		if (result == null) {
	...
	private void atThrowStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	private void atSyncStmnt(org.hotswap.agent.javassist.compiler.ast.Stmnt st)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	private static int getListSize(ArrayList<Integer> list) {
	...
	@Override
	public void atDeclarator(org.hotswap.agent.javassist.compiler.ast.Declarator d)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	@Override
	public abstract void atNewExpr(org.hotswap.agent.javassist.compiler.ast.NewExpr n)
			throws org.hotswap.agent.javassist.compiler.CompileError;

	@Override
	public abstract void atArrayInit(org.hotswap.agent.javassist.compiler.ast.ArrayInit init)
			throws org.hotswap.agent.javassist.compiler.CompileError;

	@Override
	public void atAssignExpr(org.hotswap.agent.javassist.compiler.ast.AssignExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	protected void atAssignExpr(org.hotswap.agent.javassist.compiler.ast.AssignExpr expr, boolean doDup)
		...
		if (left instanceof org.hotswap.agent.javassist.compiler.ast.Variable) {
			atVariableAssign(expr, op, (org.hotswap.agent.javassist.compiler.ast.Variable) left,
					((org.hotswap.agent.javassist.compiler.ast.Variable) left).getDeclarator(), right, doDup);
		} else {
	...
	protected static void badAssign(org.hotswap.agent.javassist.compiler.ast.Expr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		String msg;
		if (expr == null) {
	 ...
	 */
	private void atVariableAssign(org.hotswap.agent.javassist.compiler.ast.Expr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.Variable var,
			org.hotswap.agent.javassist.compiler.ast.Declarator d,
			org.hotswap.agent.javassist.compiler.ast.ASTree right, boolean doDup)
					throws org.hotswap.agent.javassist.compiler.CompileError {
		...
		if (expr == null && right instanceof org.hotswap.agent.javassist.compiler.ast.ArrayInit) {
			atArrayVariableAssign((org.hotswap.agent.javassist.compiler.ast.ArrayInit) right, varType, varArray,
					varClass);
		} else {
	...
	protected abstract void atArrayVariableAssign(org.hotswap.agent.javassist.compiler.ast.ArrayInit init, int varType,
			int varArray, String varClass) throws org.hotswap.agent.javassist.compiler.CompileError;

	private void atArrayAssign(org.hotswap.agent.javassist.compiler.ast.Expr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.Expr array, org.hotswap.agent.javassist.compiler.ast.ASTree right,
	...
	protected abstract void atFieldAssign(org.hotswap.agent.javassist.compiler.ast.Expr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.ASTree left, org.hotswap.agent.javassist.compiler.ast.ASTree right,
			boolean doDup) throws org.hotswap.agent.javassist.compiler.CompileError;

	protected void atAssignCore(org.hotswap.agent.javassist.compiler.ast.Expr expr, int op,
			org.hotswap.agent.javassist.compiler.ast.ASTree right, int type, int dim, String cname)
					throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	@Override
	public void atCondExpr(org.hotswap.agent.javassist.compiler.ast.CondExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	static final int[] binOp = { '+', DADD, FADD, LADD, IADD, '-', DSUB, FSUB, LSUB, ISUB, '*', DMUL, FMUL, LMUL, IMUL,
			'/', DDIV, FDIV, LDIV, IDIV, '%', DREM, FREM, LREM, IREM, '|', NOP, NOP, LOR, IOR, '^', NOP, NOP, LXOR,
			IXOR, '&', NOP, NOP, LAND, IAND, LSHIFT, NOP, NOP, LSHL, ISHL, RSHIFT, NOP, NOP, LSHR, ISHR, ARSHIFT, NOP,
			NOP, LUSHR, IUSHR };
	...
	@Override
	public void atBinExpr(org.hotswap.agent.javassist.compiler.ast.BinExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	 ...
	 */
	private void atArithBinExpr(org.hotswap.agent.javassist.compiler.ast.Expr expr, int token, int index, int type1)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (arrayDim != 0) {
			badTypes(expr);
		}
	...
	static int getCompOperator(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		if (expr instanceof org.hotswap.agent.javassist.compiler.ast.Expr) {
			...
			if (token == '!') {
				return '!';
			} else if (bexpr instanceof org.hotswap.agent.javassist.compiler.ast.BinExpr && token != OROR
	...
	private int compileOprands(org.hotswap.agent.javassist.compiler.ast.BinExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		expr.oprand1().accept(this);
		int type1 = exprType;
		int dim1 = arrayDim;
	...
	private static final int ifOp[] = { EQ, IF_ICMPEQ, IF_ICMPNE, NEQ, IF_ICMPNE, IF_ICMPEQ, LE, IF_ICMPLE, IF_ICMPGT,
			GE, IF_ICMPGE, IF_ICMPLT, '<', IF_ICMPLT, IF_ICMPGE, '>', IF_ICMPGT, IF_ICMPLE };

	private static final int ifOp2[] = { EQ, IFEQ, IFNE, NEQ, IFNE, IFEQ, LE, IFLE, IFGT, GE, IFGE, IFLT, '<', IFLT,
			IFGE, '>', IFGT, IFLE };
	...
	private void compareExpr(boolean branchIf, int token, int type1,
			org.hotswap.agent.javassist.compiler.ast.BinExpr expr)
					throws org.hotswap.agent.javassist.compiler.CompileError {
		if (arrayDim == 0) {
	...
	protected static void badTypes(org.hotswap.agent.javassist.compiler.ast.Expr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	@Override
	public void atCastExpr(org.hotswap.agent.javassist.compiler.ast.CastExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	@Override
	public void atInstanceOfExpr(org.hotswap.agent.javassist.compiler.ast.InstanceOfExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		String cname = resolveClassName(expr.getClassName());
		String toClass = checkCastExpr(expr, cname);
	...
	void atNumCastExpr(int srcType, int destType) throws org.hotswap.agent.javassist.compiler.CompileError {
		if (srcType == destType) {
			return;
		}
	...
	@Override
	public void atExpr(org.hotswap.agent.javassist.compiler.ast.Expr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	protected static void badType(org.hotswap.agent.javassist.compiler.ast.Expr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		throw new org.hotswap.agent.javassist.compiler.CompileError("invalid type for " + expr.getName());
	}

	@Override
	public abstract void atCallExpr(org.hotswap.agent.javassist.compiler.ast.CallExpr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError;

	protected abstract void atFieldRead(org.hotswap.agent.javassist.compiler.ast.ASTree expr)
			throws org.hotswap.agent.javassist.compiler.CompileError;

	public void atClassObject(org.hotswap.agent.javassist.compiler.ast.Expr expr)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	public void atArrayRead(org.hotswap.agent.javassist.compiler.ast.ASTree array,
	...
	protected void arrayAccess(org.hotswap.agent.javassist.compiler.ast.ASTree array,
			org.hotswap.agent.javassist.compiler.ast.ASTree index)
					throws org.hotswap.agent.javassist.compiler.CompileError {
		array.accept(this);
		int type = exprType;
	...
	private void atPlusPlus(int token, org.hotswap.agent.javassist.compiler.ast.ASTree oprand,
		...
		if (oprand instanceof org.hotswap.agent.javassist.compiler.ast.Variable) {
			org.hotswap.agent.javassist.compiler.ast.Declarator d = ((org.hotswap.agent.javassist.compiler.ast.Variable) oprand)
					.getDeclarator();
	...
	public void atArrayPlusPlus(int token, boolean isPost, org.hotswap.agent.javassist.compiler.ast.Expr expr,
			boolean doDup) throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	protected void atPlusPlusCore(int dup_code, boolean doDup, int token, boolean isPost,
			org.hotswap.agent.javassist.compiler.ast.Expr expr)
					throws org.hotswap.agent.javassist.compiler.CompileError {
		int t = exprType;
	...
	protected abstract void atFieldPlusPlus(int token, boolean isPost,
			org.hotswap.agent.javassist.compiler.ast.ASTree oprand, org.hotswap.agent.javassist.compiler.ast.Expr expr,
			boolean doDup) throws org.hotswap.agent.javassist.compiler.CompileError;

	@Override
	public abstract void atMember(org.hotswap.agent.javassist.compiler.ast.Member n)
			throws org.hotswap.agent.javassist.compiler.CompileError;

	@Override
	public void atVariable(org.hotswap.agent.javassist.compiler.ast.Variable v)
			throws org.hotswap.agent.javassist.compiler.CompileError {
	...
	@Override
	public void atKeyword(org.hotswap.agent.javassist.compiler.ast.Keyword k)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		arrayDim = 0;
		int token = k.get();
		switch (token) {
		...
		case SUPER:
			if (inStaticMethod) {
				throw new org.hotswap.agent.javassist.compiler.CompileError(
						"not-available: " + (token == THIS ? "this" : "super"));
			}
	...
	@Override
	public void atStringL(org.hotswap.agent.javassist.compiler.ast.StringL s)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		exprType = CLASS;
		arrayDim = 0;
		className = jvmJavaLangString;
	...
	@Override
	public void atIntConst(org.hotswap.agent.javassist.compiler.ast.IntConst i)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		arrayDim = 0;
		long value = i.get();
		int type = i.getType();
	...
	@Override
	public void atDoubleConst(org.hotswap.agent.javassist.compiler.ast.DoubleConst d)
			throws org.hotswap.agent.javassist.compiler.CompileError {
		arrayDim = 0;
