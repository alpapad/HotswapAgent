...
public abstract class CtBehavior extends CtMember {
	 ...
	 * as <code>org.hotswap.agent.javassist.CtBehavior.stBody(String)</code>.
	 *
	 * @since 3.5
	 */
	 ...
	 * {@link org.hotswap.agent.javassist.bytecode.AttributeInfo}.
	 *
	 * @param name
	 *            attribute name
	 */
	 ...
	 * requires a support class
	 * <code>org.hotswap.agent.javassist.runtime.Cflow</code> at runtime (other
	 * Javassist classes are not required at runtime).
	 *
	 * <p>
	...
	public void insertAfter(String src, boolean asFinally) throws CannotCompileException {
		...
		try {
			...
			while (iterator.hasNext()) {
				...
				if (c == Opcode.ARETURN || c == Opcode.IRETURN || c == Opcode.FRETURN || c == Opcode.LRETURN
