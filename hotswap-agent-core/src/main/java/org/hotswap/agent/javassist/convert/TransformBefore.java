...
public class TransformBefore extends TransformCall {
	...
	public TransformBefore(Transformer next, org.hotswap.agent.javassist.CtMethod origMethod,
			org.hotswap.agent.javassist.CtMethod beforeMethod) throws org.hotswap.agent.javassist.NotFoundException {
	...
	@Override
	protected int match(int c, int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iterator, int typedesc,
	...
	protected int match2(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator iterator)
	...
	protected void makeCode(org.hotswap.agent.javassist.CtClass[] paramTypes,
			org.hotswap.agent.javassist.bytecode.ConstPool cp) {
		org.hotswap.agent.javassist.bytecode.Bytecode save = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 0,
				0);
		org.hotswap.agent.javassist.bytecode.Bytecode load = new org.hotswap.agent.javassist.bytecode.Bytecode(cp, 0,
				0);
	...
	private void makeCode2(org.hotswap.agent.javassist.bytecode.Bytecode save,
			org.hotswap.agent.javassist.bytecode.Bytecode load, int i, int n,
			org.hotswap.agent.javassist.CtClass[] paramTypes, int var) {
		if (i < n) {
