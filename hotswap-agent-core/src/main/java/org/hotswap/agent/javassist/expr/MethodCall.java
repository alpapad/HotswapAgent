...
public class MethodCall extends Expr {
	 ...
	 */
	protected MethodCall(int pos, org.hotswap.agent.javassist.bytecode.CodeIterator i,
	...
	public void replace(String statement) throws org.hotswap.agent.javassist.CannotCompileException {
		...
		try {
			...
			org.hotswap.agent.javassist.CtClass retType = org.hotswap.agent.javassist.bytecode.Descriptor
					.getReturnType(signature, cp);
			...
			if (c == INVOKESTATIC) {
				...
				jc.recordSpecialProceed(org.hotswap.agent.javassist.compiler.Javac.param0Name, classname, methodname,
						signature);
			} else {
