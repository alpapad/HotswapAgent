...
public class CodeAttribute extends AttributeInfo implements Opcode {
	 ...
	 * Copies code.
	 */
	private byte[] copyCode(ConstPool destCp, Map<String, String> classnames, ExceptionTable etable,
			CodeAttribute destCa) throws BadBytecode {
	...
	private static LdcEntry copyCode(byte[] code, int beginPos, int endPos, ConstPool srcCp, byte[] newcode,
