...
public class Descriptor {
	 ...
	 *            parameter types
	 */
	public static String ofMethod(org.hotswap.agent.javassist.CtClass returnType,
			org.hotswap.agent.javassist.CtClass[] paramTypes) {
	 ...
	 */
	public static String insertParameter(org.hotswap.agent.javassist.CtClass type, String descriptor) {
	 ...
	 *            object.
	 */
	public static org.hotswap.agent.javassist.CtClass[] getParameterTypes(String desc,
	 ...
	 *            object.
	 */
	public static org.hotswap.agent.javassist.CtClass getReturnType(String desc,
			org.hotswap.agent.javassist.ClassPool cp) throws org.hotswap.agent.javassist.NotFoundException {
		int i = desc.indexOf(')');
		if (i < 0) {
			return null;
	...
	private static int toCtClass(org.hotswap.agent.javassist.ClassPool cp, String desc, int i,
			org.hotswap.agent.javassist.CtClass[] args, int n) throws org.hotswap.agent.javassist.NotFoundException {
		int i2;
		String name;
