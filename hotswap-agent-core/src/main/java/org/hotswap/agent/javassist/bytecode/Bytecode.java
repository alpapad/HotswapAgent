 ...
 * CodeAttribute ca = b.toCodeAttribute();</ul>
 * </pre>
 * <p/>
 * <p>
...
public class Bytecode extends ByteVector implements Cloneable, Opcode {
	 ...
	 *            parameters.
	 */
	public void setMaxLocals(boolean isStatic, org.hotswap.agent.javassist.CtClass[] params, int locals) {
		if (!isStatic) {
			++locals;
		}
	 ...
	 */
	public void addExceptionHandler(int start, int end, int handler, org.hotswap.agent.javassist.CtClass type) {
	 ...
	 * @see Descriptor#ofMethod(org.hotswap.agent.javassist.CtClass,
	 ...
	 *      org.hotswap.agent.javassist.CtClass[])
	 */
	public void addInvokeinterface(org.hotswap.agent.javassist.CtClass clazz, String name, String desc, int count) {
	...
	private void addPutfield0(org.hotswap.agent.javassist.CtClass target, String classname, String name, String desc) {
		add(PUTFIELD);
	...
	private void addPutstatic0(org.hotswap.agent.javassist.CtClass target, String classname, String fieldName,
			String desc) {
		add(PUTSTATIC);
		// target is null if it represents THIS.
		int ci = classname == null ? constPool.addClassInfo(target) : constPool.addClassInfo(classname);
