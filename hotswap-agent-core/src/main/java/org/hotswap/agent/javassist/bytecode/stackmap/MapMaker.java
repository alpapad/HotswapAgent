...
import org.hotswap.agent.javassist.bytecode.stackmap.TypeData.TypeVar;
...
public class MapMaker extends Tracer {
	 ...
	 * cp = ClassPool.getDefault(); //CtClass cc = cp.get(className); CtClass cc
	 * = cp.makeClass(new java.io.FileInputStream(className));
	 ...
	 * ClassPool.getDefault(); //CtClass cc = cp.get(args[1]); CtClass cc =
	 ...
	 * or it includes JSR.
	 */
	public static org.hotswap.agent.javassist.bytecode.StackMapTable make(org.hotswap.agent.javassist.ClassPool classes,
	 ...
	 */
	public static org.hotswap.agent.javassist.bytecode.StackMap make2(org.hotswap.agent.javassist.ClassPool classes,
			org.hotswap.agent.javassist.bytecode.MethodInfo minfo)
					throws org.hotswap.agent.javassist.bytecode.BadBytecode {
		org.hotswap.agent.javassist.bytecode.CodeAttribute ca = minfo.getCodeAttribute();
		if (ca == null) {
	...
	public MapMaker(org.hotswap.agent.javassist.ClassPool classes,
			org.hotswap.agent.javassist.bytecode.MethodInfo minfo,
			org.hotswap.agent.javassist.bytecode.CodeAttribute ca) {
	...
	private void make(byte[] code, org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock tb)
		...
		if (tb.exit != null) {
			for (BasicBlock element : tb.exit) {
				org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock e = (org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock) element;
				if (e.alreadySet()) {
					mergeMap(e, true);
				} else {
					recordStackMap(e);
			...
			if (tb.alreadySet()) {
				...
				if (tb.stackTop < 1) {
					throw new org.hotswap.agent.javassist.bytecode.BadBytecode(
							"bad catch clause: " + handler.typeIndex);
				}
	...
	private void mergeMap(org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock dest, boolean mergeStack)
			throws org.hotswap.agent.javassist.bytecode.BadBytecode {
	...
	private org.hotswap.agent.javassist.bytecode.stackmap.TypeData merge(
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData src,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData target)
					throws org.hotswap.agent.javassist.bytecode.BadBytecode {
		if (src == target) {
			return target;
		} else if (target instanceof org.hotswap.agent.javassist.bytecode.stackmap.TypeData.ClassName
				|| target instanceof org.hotswap.agent.javassist.bytecode.stackmap.TypeData.BasicType) {
			return target;
	...
	private void recordStackMap(org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock target)
			throws org.hotswap.agent.javassist.bytecode.BadBytecode {
		org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] tStackTypes = org.hotswap.agent.javassist.bytecode.stackmap.TypeData
				.make(stackTypes.length);
		int st = stackTop;
	...
	private void recordStackMap0(org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock target, int st,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] tStackTypes)
					throws org.hotswap.agent.javassist.bytecode.BadBytecode {
		int n = localsTypes.length;
		org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] tLocalsTypes = org.hotswap.agent.javassist.bytecode.stackmap.TypeData
				.make(n);
		int k = recordTypeData(n, localsTypes, tLocalsTypes);
		target.setStackMap(st, tStackTypes, k, tLocalsTypes);
	}

	protected static int recordTypeData(int n, org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] srcTypes,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] destTypes) {
		int k = -1;
		for (int i = 0; i < n; i++) {
	...
	protected static void copyTypeData(int n, org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] srcTypes,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] destTypes) {
		for (int i = 0; i < n; i++) {
	...
	private void findDeadCatchers(byte[] code, org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock[] blocks)
			throws org.hotswap.agent.javassist.bytecode.BadBytecode {
			...
			if (block.localsTypes == null) { // if block is dead code
				...
				while (handler != null) {
					if (handler.body == block) {
						BasicBlock.Catch handler2 = new BasicBlock.Catch(block, handler.typeIndex, null);
	...
	/*
	 * This method first finds strongly connected components (SCCs) on a graph
	 * made by TypeData by Tarjan's algorithm. SCCs are TypeData nodes sharing
	 * the same type. Since SCCs are found in the topologically sorted order,
	 * their types are also fixed when they are found.
	 */
	private void fixTypes(byte[] code, org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock[] blocks)
			throws org.hotswap.agent.javassist.NotFoundException, org.hotswap.agent.javassist.bytecode.BadBytecode {
		ArrayList<TypeVar> preOrder = new ArrayList<TypeVar>();
		int len = blocks.length;
		int index = 0;
		for (int i = 0; i < len; i++) {
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock block = blocks[i];
	...
	private void fixDeadcode(byte[] code, org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock block)
			throws org.hotswap.agent.javassist.bytecode.BadBytecode {
		int pos = block.position;
		int len = block.length - 3;
		if (len < 0) {
			throw new org.hotswap.agent.javassist.bytecode.BadBytecode(
					"dead code detected at " + pos + ".  No stackmap table generated.");
		}
	...
	public org.hotswap.agent.javassist.bytecode.StackMapTable toStackMap(
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock[] blocks) {
	 ...
	 */
	private boolean isTarget(org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock cur,
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock prev) {
		int in = cur.incoming;
		if (in > 1) {
			return true;
		} else if (in < 1) {
	...
	private void toStackMapBody(org.hotswap.agent.javassist.bytecode.StackMapTable.Writer writer,
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock bb, int diffL, int offsetDelta,
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock prev) {
	...
	private int[] fillStackMap(int num, int offset, int[] data,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] types) {
	...
	private static boolean stackMapEq(org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] oldTd,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] newTd, int len) {
		for (int i = 0; i < len; i++) {
	...
	public org.hotswap.agent.javassist.bytecode.StackMap toStackMap2(org.hotswap.agent.javassist.bytecode.ConstPool cp,
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock[] blocks) {
	...
	private void writeStackFrame(org.hotswap.agent.javassist.bytecode.StackMap.Writer writer,
			org.hotswap.agent.javassist.bytecode.ConstPool cp, int offset,
			org.hotswap.agent.javassist.bytecode.stackmap.TypedBlock tb) {
	...
	private void writeVerifyTypeInfo(org.hotswap.agent.javassist.bytecode.StackMap.Writer writer,
			org.hotswap.agent.javassist.bytecode.ConstPool cp,
			org.hotswap.agent.javassist.bytecode.stackmap.TypeData[] types, int num) {
		int numDWord = 0;
		for (int i = 0; i < num; i++) {
