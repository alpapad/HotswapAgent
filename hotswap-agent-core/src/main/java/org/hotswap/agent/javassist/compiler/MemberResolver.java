...
public class MemberResolver implements TokenId {
	...
	public Method lookupMethod(org.hotswap.agent.javassist.CtClass clazz,
			org.hotswap.agent.javassist.CtClass currentClass, org.hotswap.agent.javassist.bytecode.MethodInfo current,
	...
	private Method lookupMethod(org.hotswap.agent.javassist.CtClass clazz, String methodName, int[] argTypes,
			int[] argDims, String[] argClassNames, boolean onlyExact) throws CompileError {
		Method maybe = null;
		...
		if (cf != null) {
			...
			int n = list.size();
			for (int i = 0; i < n; ++i) {
				org.hotswap.agent.javassist.bytecode.MethodInfo minfo = list
						.get(i);
	 ...
	 */
	public org.hotswap.agent.javassist.CtField lookupFieldByJvmName2(String jvmClassName,
			org.hotswap.agent.javassist.compiler.ast.Symbol fieldSym,
			org.hotswap.agent.javassist.compiler.ast.ASTree expr)
					throws org.hotswap.agent.javassist.compiler.NoFieldException {
	 ...
	 *            a JVM class name. e.g. java/lang/String
	 */
	public org.hotswap.agent.javassist.CtField lookupFieldByJvmName(String jvmClassName,
			org.hotswap.agent.javassist.compiler.ast.Symbol fieldName) throws CompileError {
	 ...
	 */
	public org.hotswap.agent.javassist.CtField lookupField(String className,
			org.hotswap.agent.javassist.compiler.ast.Symbol fieldName) throws CompileError {
	...
	public org.hotswap.agent.javassist.CtClass lookupClassByName(org.hotswap.agent.javassist.compiler.ast.ASTList name)
			throws CompileError {
	...
	public org.hotswap.agent.javassist.CtClass lookupClass(org.hotswap.agent.javassist.compiler.ast.Declarator decl)
			throws CompileError {
	 ...
	 */
	public org.hotswap.agent.javassist.CtClass lookupClass(int type, int dim, String classname) throws CompileError {
		String cname = "";
	...
	private static WeakHashMap<ClassPool, WeakReference<Hashtable<String, String>>> invalidNamesMap = new WeakHashMap<ClassPool, WeakReference<Hashtable<String, String>>>();
	private Hashtable<String, String> invalidNames = null;
	...
	private Hashtable<String, String> getInvalidNames() {
		Hashtable<String, String> ht = invalidNames;
		if (ht == null) {
			synchronized (MemberResolver.class) {
				WeakReference<Hashtable<String, String>> ref = invalidNamesMap.get(classPool);
				if (ref != null) {
					ht = ref.get();
				}
				...
				if (ht == null) {
					...
					invalidNamesMap.put(classPool, new WeakReference<Hashtable<String, String>>(ht));
				}
			}
	...
	private org.hotswap.agent.javassist.CtClass searchImports(String orgName) throws CompileError {
	...
	public static org.hotswap.agent.javassist.CtClass getSuperclass(org.hotswap.agent.javassist.CtClass c)
			throws CompileError {
		try {
