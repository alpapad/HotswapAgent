...
import org.hotswap.agent.plugin.hibernate3.session.Hibernate3Plugin;
...
public class Hibernate3JPAHelper {
	...
	private static void initPlugin(EntityManagerFactory original) {
		...
		PluginManagerInvoker.callInitializePlugin(Hibernate3Plugin.class, appClassLoader);
		PluginManagerInvoker.callPluginMethod(Hibernate3Plugin.class, appClassLoader, "init", new Class[] { String.class, Boolean.class }, new Object[] { version, true });
