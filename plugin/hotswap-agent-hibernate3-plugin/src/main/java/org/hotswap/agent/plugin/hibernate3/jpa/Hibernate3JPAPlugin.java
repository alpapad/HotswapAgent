...
import org.hotswap.agent.plugin.hibernate3.jpa.HibernateJPARefreshCommands;
...
public class Hibernate3JPAPlugin {
	...
	// refresh commands
	Command reloadEntityManagerFactoryCommand = new ReflectionCommand(this, HibernateJPARefreshCommands.class.getName(),
