...
public class BeanDeploymentArchiveTransformer {
    ...
    public static void transform(CtClass clazz, ClassPool classPool, Class<?> orig, ClassLoader cl) throws NotFoundException, CannotCompileException {
    ...
    public static void transformJbossBda(CtClass clazz, ClassPool classPool, Class<?> orig, ClassLoader cl) throws NotFoundException, CannotCompileException {
